 ...
 * style-5.php
 *
 * The template for displaying "style 5" of newsletter pack shortcode
 *
 * @author    BetterStudio
...
if ( ! empty( $atts['color'] ) ) {
	...
	#$custom_id.bs-newsletter-pack.bsnp-t1 .bsnp-ic.bsnp-ic,
	#$custom_id.bs-newsletter-pack.bsnp-t1:before,
...
?>
	...
	?> class="bs-shortcode bs-newsletter-pack bsnp-<?php echo $atts['type']; ?> bsnp-st-<?php echo $atts['style-type']; ?> bsnp-t1 bsnp-s5 <?php echo $atts['css-class']; ?>">
		<?php
