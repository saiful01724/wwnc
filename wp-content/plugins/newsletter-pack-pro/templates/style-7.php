 ...
 * style-7.php
 *
 * The template for displaying "style 7" of newsletter pack shortcode
 *
 * @author    BetterStudio
...
?>
	...
	?> class="bs-shortcode bs-newsletter-pack bsnp-<?php echo $atts['type']; ?> bsnp-st-<?php echo $atts['style-type']; ?> bsnp-t1 bsnp-s7 bsnp-st-wide-2col clearfix <?php echo $atts['css-class']; ?>">
		<?php
		...
		<?php if ( $stack_items['icon'] ) { ?>
			<div class="bsnp-ic bsnp-ic-img">
				<img src="<?php echo BS_Newsletter_Pack_Pro::dir_url( 'images/newsletters/envelope-2.png?v=' . BS_Newsletter_Pack_Pro::get_version() ) ?>"
