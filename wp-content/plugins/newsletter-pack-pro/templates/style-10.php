 ...
 * style-10.php
 *
 * The template for displaying "style 10" of newsletter pack shortcode
 *
 * @author    BetterStudio
...
?>
	...
	?> class="bs-shortcode bs-newsletter-pack bsnp-<?php echo $atts['type']; ?> bsnp-st-<?php echo $atts['style-type']; ?> bsnp-t1 bsnp-s10 <?php echo $atts['css-class']; ?>">
		<?php
