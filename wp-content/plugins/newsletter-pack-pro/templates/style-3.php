 ...
 * style-3.php
 *
 * The template for displaying "style 3" of newsletter pack shortcode
 *
 * @author    BetterStudio
...
if ( ! empty( $atts['color'] ) ) {
	...
	#$custom_id.bs-newsletter-pack .bsnp-ic,
	#$custom_id.bs-newsletter-pack:before,
...
?>
	...
	?> class="bs-shortcode bs-newsletter-pack bsnp-<?php echo $atts['type']; ?> bsnp-st-<?php echo $atts['style-type']; ?> bsnp-t1 bsnp-s3 <?php echo $atts['css-class']; ?>">
		<?php
		...
		<div class="bsnp-bc">
			...
			if ( $stack_items['social-icons'] && ! empty( $atts['social_icons'] ) ) {
