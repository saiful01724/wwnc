 ...
 * style-9.php
 *
 * The template for displaying "style 9" of newsletter pack shortcode
 *
 * @author    BetterStudio
...
?>
	...
	?> class="bs-shortcode bs-newsletter-pack bsnp-<?php echo $atts['type']; ?> bsnp-st-<?php echo $atts['style-type']; ?> bsnp-t1 bsnp-s9 bsnp-st-wide-2col clearfix <?php echo $atts['css-class']; ?>">
		<?php
		...
		<?php if ( $stack_items['icon'] ) { ?>
			<div class="bsnp-ic bsnp-ic-img">
				<img src="<?php echo BS_Newsletter_Pack_Pro::dir_url( 'images/newsletters/envelope-4.png?v=' . BS_Newsletter_Pack_Pro::get_version() ) ?>"
		...
		<div class="bsnp-bc">
			...
			<?php echo bsnp_get_form_code( $atts, array(
				'form-fields-wrapper-class' => 'bsnp-1-row'
			) ); ?>
