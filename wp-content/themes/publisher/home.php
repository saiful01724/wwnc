 ...
 * home.php
 *
 * Used to none-static homepage.
 *
 * Content is output based on which layout has been selected in theme option panel.
 * To view and/or edit the markup of layouts, go to "views/home/layout" there is
...
publisher_get_view( 'home', 'layout-' . publisher_get_page_layout_file() );
