...
<ul id="bbp-topic-<?php bbp_topic_id(); ?>" <?php bbp_topic_class(); ?>>
	...
	<li class="bbp-topic-title">
		...
		<p class="bbp-topic-meta">
			...
			<span
				class="bbp-topic-started-by"><?php echo publisher_translation_get( 'bbp_started_by' ), ' ', bbp_get_topic_author_link( array( 'type' => 'name' ) ); ?></span>
			...
			<?php if ( ! bbp_is_single_forum() || ( bbp_get_topic_forum_id() !== bbp_get_forum_id() ) ) : ?>
				...
				<span
					class="bbp-topic-started-in"><?php printf( publisher_translation_get( 'bbp_in' ) . ' <a href="%1$s">%2$s</a>', bbp_get_forum_permalink( bbp_get_topic_forum_id() ), bbp_get_forum_title( bbp_get_topic_forum_id() ) ); ?></span>
			...
			<span class="last-post">
				<?php publisher_translation_echo( 'bbp_last_post' ); ?> <?php bbp_author_link( array(
					'post_id' => bbp_get_topic_last_active_id(),
					'type'    => 'name'
				) ); ?>
	...
	<li class="bbp-topic-reply-posts-count topic-row"><span
		...
		<br>
		<?php echo bbp_show_lead_topic() ? '<span class="count">' . bbp_get_topic_reply_count() . '</span> ' . publisher_translation_get( 'bbp_replies' ) : '<span class="count">' . bbp_topic_post_count() . '</span> ' . publisher_translation_get( 'bbp_posts' ); ?>
	</li>
