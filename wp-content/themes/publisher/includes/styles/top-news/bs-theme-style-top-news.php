 ...
 * Publisher -> Top News
 */
class Publisher_Theme_Style_top_news extends Publisher_Theme_Style {
	...
	function panel_css( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/top-news/panel-css.php';
	...
	function panel_std( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/top-news/panel-std.php';
	...
	function register_assets() {
		...
		bf_enqueue_style(
			'publisher-theme-top-news',
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_uri( 'top-news/style' ), '.css' ),
			array( 'publisher' ),
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_path( 'top-news/style' ), '.css' ),
	...
	public function register_tinymce_assets() {
		...
		bf_enqueue_tinymce_style( 'registered', 'publisher-theme-top-news' );
	}
