 ...
 * Publisher -> Newswatch
 */
class Publisher_Theme_Style_Newswatch extends Publisher_Theme_Style {
	...
	function panel_std( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/newswatch/panel-std.php';
	...
	function panel_css( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/newswatch/panel-css.php';
	...
	function register_assets() {
		...
		bf_enqueue_style(
			'publisher-theme-newswatch',
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_uri( 'newswatch/style' ), '.css' ),
			array( 'publisher' ),
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_path( 'newswatch/style' ), '.css' ),
	...
	public function register_tinymce_assets() {
		...
		bf_enqueue_tinymce_style( 'registered', 'publisher-theme-newswatch' );
	}
...
} // Publisher_Theme_Style_Newswatch
