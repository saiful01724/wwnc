 ...
 */
class Publisher_Theme_Style_Online_Magazine extends Publisher_Theme_Style {
	...
	function panel_std( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/online-magazine/panel-std.php';
	...
	function panel_css( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/online-magazine/panel-css.php';
	...
	function register_assets() {
		...
		bf_enqueue_style(
			'publisher-theme-online-magazine',
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_uri( 'online-magazine/style' ), '.css' ),
			array( 'publisher' ),
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_path( 'online-magazine/style' ), '.css' ),
	...
	function customize_category_fields( $fields ) {
		...
		$term_css['bg_color']['selector'][] = '.site-header.site-header .main-menu.menu > li.menu-term-%%id%%:hover > a';
		$term_css['bg_color']['selector'][] = '.site-header.site-header .main-menu.menu > li.menu-term-%%id%%.current-menu-item > a';
		$term_css['bg_color']['selector'][] = '.site-header.site-header .main-menu.menu > li.menu-term-%%id%%.current-menu-parent > a';
		$term_css['bg_color']['selector'][] = '.site-header.site-header .main-menu.menu > li.menu-term-%%id%%.current-post-ancestor > a';
		$term_css['bg_color']['selector'][] = '.site-header.site-header .main-menu.menu > li.menu-term-%%id%% .mega-menu';
	...
	public function register_tinymce_assets() {
		...
		bf_enqueue_tinymce_style( 'registered', 'publisher-theme-online-magazine' );
	}
...
} // Publisher_Theme_Style_online_magazine
