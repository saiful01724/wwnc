...
/**
 * Publisher -> Life Daily
 */
class Publisher_Theme_Style_Life_Daily extends Publisher_Theme_Style {
	...
	function panel_std( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/life-daily/panel-std.php';
	...
	function panel_css( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/life-daily/panel-css.php';
	...
	function register_assets() {
		...
		bf_enqueue_style(
			'publisher-theme-life-daily',
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_uri( 'life-daily/style' ), '.css' ),
			array( 'publisher' ),
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_path( 'life-daily/style' ), '.css' ),
	...
	public function register_tinymce_assets() {
		...
		bf_enqueue_tinymce_style( 'registered', 'publisher-theme-life-daily' );
	}
...
} // Publisher_Theme_Style_Life_Daily
