...
/**
 * Publisher -> Adventure Blog
 */
class Publisher_Theme_Style_adventure_blog extends Publisher_Theme_Style {
	...
	function panel_std( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/adventure-blog/panel-std.php';
	...
	function panel_css( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/adventure-blog/panel-css.php';
	...
	function register_assets() {
		...
		bf_enqueue_style(
			'publisher-theme-adventure-blog',
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_uri( 'adventure-blog/style' ), '.css' ),
			array( 'publisher' ),
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_path( 'adventure-blog/style' ), '.css' ),
	...
	public function register_tinymce_assets() {
		...
		bf_enqueue_tinymce_style( 'registered', 'publisher-theme-adventure-blog' );
	}
...
} // Publisher_Theme_Style_adventure_blog
