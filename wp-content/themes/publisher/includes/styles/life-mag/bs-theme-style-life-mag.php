 ...
 * Publisher -> Life Maga
 */
class Publisher_Theme_Style_Life_Mag extends Publisher_Theme_Style {
	...
	function panel_std( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/life-mag/panel-std.php';
	...
	function panel_css( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/life-mag/panel-css.php';
	...
	function register_assets() {
		...
		bf_enqueue_style(
			'publisher-theme-life-mag',
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_uri( 'life-mag/style' ), '.css' ),
			array( 'publisher' ),
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_path( 'life-mag/style' ), '.css' ),
	...
	public function register_tinymce_assets() {
		...
		bf_enqueue_tinymce_style( 'registered', 'publisher-theme-life-mag' );
	}
...
} // Publisher_Theme_Style_Life_Mag
