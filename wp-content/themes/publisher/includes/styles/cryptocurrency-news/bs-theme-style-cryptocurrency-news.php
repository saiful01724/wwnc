...
/**
 * Publisher -> Cryptocurrency News
 */
class Publisher_Theme_Style_Cryptocurrency_News extends Publisher_Theme_Style {
	...
	public function __construct() {
		...
		$this->style_id = 'cryptocurrency-news';
	...
	function panel_std( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/cryptocurrency-news/panel-std.php';
	...
	function panel_css( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/cryptocurrency-news/panel-css.php';
	...
	function register_assets() {
		...
		bf_enqueue_style(
			'publisher-theme-cryptocurrency-news',
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_uri( 'cryptocurrency-news/style' ), '.css' ),
			array( 'publisher' ),
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_path( 'cryptocurrency-news/style' ), '.css' ),
	...
	public function register_tinymce_assets() {
		...
		bf_enqueue_tinymce_style( 'registered', 'publisher-theme-cryptocurrency-news' );
	}
...
} // Publisher_Theme_Style_Cryptocurrency_News
