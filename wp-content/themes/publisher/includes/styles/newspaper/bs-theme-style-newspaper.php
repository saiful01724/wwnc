 ...
 * Publisher -> Newspaper
 */
class Publisher_Theme_Style_Newspaper extends Publisher_Theme_Style {
	...
	function panel_std( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/newspaper/panel-std.php';
	...
	function panel_css( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/newspaper/panel-css.php';
	...
	function register_assets() {
		...
		bf_enqueue_style(
			'publisher-theme-newspaper',
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_uri( 'newspaper/style' ), '.css' ),
			array( 'publisher' ),
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_path( 'newspaper/style' ), '.css' ),
	...
	public function register_tinymce_assets() {
		...
		bf_enqueue_tinymce_style( 'registered', 'publisher-theme-newspaper' );
	}
...
} // Publisher_Theme_Style_Newspaper
