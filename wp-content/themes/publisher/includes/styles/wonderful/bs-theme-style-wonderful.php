 ...
 * Publisher -> Wonderful
 */
class Publisher_Theme_Style_Wonderful extends Publisher_Theme_Style {
	...
	function panel_std( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/wonderful/panel-std.php';
	...
	function panel_css( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/wonderful/panel-css.php';
	...
	function register_assets() {
		...
		bf_enqueue_style(
			'publisher-theme-wonderful',
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_uri( 'wonderful/style' ), '.css' ),
			array( 'publisher' ),
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_path( 'wonderful/style' ), '.css' ),
	...
	public function register_tinymce_assets() {
		...
		bf_enqueue_tinymce_style( 'registered', 'publisher-theme-wonderful' );
	}
...
} // Publisher_Theme_Style_Wonderful
