<?php
//
// Custom default values for bold-mag Demo
// 
...
$fields['theme_color'][ $std_id ]                    = '#ffd800';
$fields['topbar_text_color'][ $std_id ]              = '#a3a3a3';
$fields['topbar_text_hcolor'][ $std_id ]             = '#ffffff';
$fields['topbar_bg_color'][ $std_id ]                = '#131313';
$fields['topbar_border_color'][ $std_id ]            = '#212121';
$fields['topbar_icon_text_color'][ $std_id ]         = '#a3a3a3';
$fields['topbar_icon_text_hcolor'][ $std_id ]        = '#ffffff';
$fields['header_top_border'][ $std_id ]              = '0';
$fields['header_menu_st8_bbottom_color'][ $std_id ]  = '#131313';
$fields['header_menu_text_color'][ $std_id ]         = '#ffffff';
$fields['header_menu_bg_color'][ $std_id ]           = '#131313';
$fields['header_bg_color'][ $std_id ]                = '#131313';
$fields['footer_widgets_bg_color'][ $std_id ]        = '#131313';
$fields['footer_menu_bg_color'][ $std_id ]           = '#2b2b2b';
$fields['footer_copy_bg_color'][ $std_id ]           = '#131313';
$fields['footer_social_bg_color'][ $std_id ]         = '#131313';
$fields['footer_bg_color'][ $std_id ]                = '#131313';
$fields['section_title_color'][ $std_id ]            = '#ffffff';
$fields['section_title_bg_color'][ $std_id ]         = '#0f0f0f';
$fields['term_badge_text_color'][ $std_id ]          = '#000000';
...
$fields['typo_post_tp1_heading'][ $std_id ]          = '29px';
$fields['typo_post_tp2_heading'][ $std_id ]          = '29px';
$fields['typo_post_tp3_heading'][ $std_id ]          = '29px';
$fields['typo_post_tp4_heading'][ $std_id ]          = '29px';
$fields['typo_post_tp5_heading'][ $std_id ]          = '29px';
$fields['typo_post_tp6_heading'][ $std_id ]          = '29px';
$fields['typo_post_tp7_heading'][ $std_id ]          = '29px';
$fields['typo_post_tp8_heading'][ $std_id ]          = '29px';
$fields['typo_post_tp9_heading'][ $std_id ]          = '29px';
$fields['typo_post_tp10_heading'][ $std_id ]         = '29px';
$fields['typo_post_tp11_heading'][ $std_id ]         = '27px';
$fields['typo_post_tp12_heading'][ $std_id ]         = '27px';
$fields['typo_post_tp13_heading'][ $std_id ]         = '27px';
...
$fields['typo_mg_10_subtitle'][ $std_id ]            = '15';
