 ...
 * Publisher -> Seo News
 */
class Publisher_Theme_Style_Seo_News extends Publisher_Theme_Style {
	...
	function panel_std( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/seo-news/panel-std.php';
	...
	function panel_css( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/seo-news/panel-css.php';
	...
	function customize_category_fields( $fields ) {
		...
		$term_css['bg_color']['selector'][] = 'body.category-%%id%% .site-header > .topbar';
		...
		$term_css['color']['selector'][] = 'body.single-prim-cat-%%id%% .entry-content.single-post-content > p > a';
		// Background Color
	...
	function register_assets() {
		...
		bf_enqueue_style(
			'publisher-theme-seo-news',
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_uri( 'seo-news/style' ), '.css' ),
			array( 'publisher' ),
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_path( 'seo-news/style' ), '.css' ),
	...
	public function register_tinymce_assets() {
		...
		bf_enqueue_tinymce_style( 'registered', 'publisher-theme-seo-news' );
	}
...
} // Publisher_Theme_Style_Seo_News
