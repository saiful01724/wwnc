...
/**
 * Publisher -> Celebrity_news
 */
class Publisher_Theme_Style_Celebrity_News extends Publisher_Theme_Style {
	...
	function register_assets() {
		...
		bf_enqueue_style(
			'publisher-theme-celebrity-news',
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_uri( 'celebrity-news/style' ), '.css' ),
			array( 'publisher' ),
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_path( 'celebrity-news/style' ), '.css' ),
	...
	public function register_tinymce_assets() {
		...
		bf_enqueue_tinymce_style( 'registered', 'publisher-theme-celebrity-news' );
	}
	...
	function panel_std( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/celebrity-news/panel-std.php';
	...
	function panel_css( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/celebrity-news/panel-css.php';
...
} // Publisher_Theme_Style_Celebrity_News
