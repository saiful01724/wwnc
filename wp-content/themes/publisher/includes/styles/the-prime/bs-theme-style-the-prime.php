...
/**
 * Publisher -> The Prime Demo
 */
class Publisher_Theme_Style_The_Prime extends Publisher_Theme_Style {
	...
	function register_assets() {
		...
		bf_enqueue_style(
			'publisher-theme-the-prime',
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_uri( 'the-prime/style' ), '.css' ),
			array( 'publisher' ),
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_path( 'the-prime/style' ), '.css' ),
	...
	public function register_tinymce_assets() {
		...
		bf_enqueue_tinymce_style( 'registered', 'publisher-theme-the-prime' );
	}
	...
	function panel_std( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/the-prime/panel-std.php';
	...
	function panel_css( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/the-prime/panel-css.php';
...
} // Publisher_Theme_Style_The_Prime
