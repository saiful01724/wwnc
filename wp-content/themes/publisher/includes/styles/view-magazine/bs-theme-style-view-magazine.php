...
/**
 * Publisher -> View Magazine
 */
class Publisher_Theme_Style_View_Magazine extends Publisher_Theme_Style {
	...
	function panel_std( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/view-magazine/panel-std.php';
	...
	function panel_css( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/view-magazine/panel-css.php';
	...
	function register_assets() {
		...
		bf_enqueue_style(
			'publisher-theme-view-magazine',
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_uri( 'view-magazine/style' ), '.css' ),
			array( 'publisher' ),
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_path( 'view-magazine/style' ), '.css' ),
	...
	public function register_tinymce_assets() {
		...
		bf_enqueue_tinymce_style( 'registered', 'publisher-theme-view-magazine' );
	}
...
} // Publisher_Theme_Style_View_Magazine
