...
/**
 * Publisher -> World Cup News
 */
class Publisher_Theme_Style_World_Cup_News extends Publisher_Theme_Style {
	...
	function panel_std( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/world-cup-news/panel-std.php';
	...
	function panel_css( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/world-cup-news/panel-css.php';
	...
	function register_assets() {
		...
		bf_enqueue_style(
			'publisher-theme-world-cup-news',
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_uri( 'world-cup-news/style' ), '.css' ),
			array( 'publisher' ),
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_path( 'world-cup-news/style' ), '.css' ),
	...
	public function register_tinymce_assets() {
		...
		bf_enqueue_tinymce_style( 'registered', 'publisher-theme-world-cup-news' );
	}
...
} // Publisher_Theme_Style_World_Cup_News
