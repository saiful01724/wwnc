<?php
//
// Custom default values for foodly Demo
// 
...
$fields['section_heading_style'][ $std_id ]          = 't6-s8';
...
$fields['footer_widgets_heading_style'][ $std_id ]   = 't7-s1';
$fields['footer_social_feed'][ $std_id ]             = 'style-3';
$fields['footer_social'][ $std_id ]                  = 'hide';
$fields['theme_color'][ $std_id ]                    = '#f37131';
$fields['site_bg_color'][ $std_id ]                  = '#f9f2e1';
$fields['header_top_border_color'][ $std_id ]        = '#d95d20';
$fields['header_menu_btop_color'][ $std_id ]         = '#d9d9d9';
$fields['header_menu_st2_bbottom_color'][ $std_id ]  = '#d9d9d9';
$fields['header_menu_text_color'][ $std_id ]         = '#3e3e3e';
$fields['header_menu_bg_color'][ $std_id ]           = '#faf9f7';
$fields['footer_link_color'][ $std_id ]              = 'rgba(249,242,225,0.7)';
$fields['footer_link_hover_color'][ $std_id ]        = '#f9f2e1';
$fields['footer_line_top_color'][ $std_id ]          = '#f37131';
$fields['footer_menu_bg_color'][ $std_id ]           = '#545147';
$fields['footer_copy_bg_color'][ $std_id ]           = '#656156';
$fields['footer_bg_color'][ $std_id ]                = '#656156';
$fields['widget_bg_color'][ $std_id ]                = '#faf9f7';
$fields['section_title_bg_color'][ $std_id ]         = '#f37131';
$fields['listings_readmore_color'][ $std_id ]        = '#9b9994';
$fields['listings_readmore_color_hover'][ $std_id ]  = '#898782';
