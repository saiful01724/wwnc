<?php
//
// Custom default values for daily-mag Demo
// 
...
$fields['section_heading_style'][ $std_id ]          = 't4-s6';
...
$fields['header_bottom_padding'][ $std_id ]          = '24';
...
$fields['social_share_bottom_style'][ $std_id ]      = 'style-12';
$fields['footer_widgets'][ $std_id ]                 = '3-column';
$fields['footer_widgets_heading_style'][ $std_id ]   = 't5-s1';
$fields['footer_social'][ $std_id ]                  = 'hide';
$fields['theme_color'][ $std_id ]                    = '#e13434';
$fields['site_bg_color'][ $std_id ]                  = '#efefef';
$fields['topbar_date_bg'][ $std_id ]                 = 'rgba(33,33,33,0)';
...
$fields['topbar_bg_color'][ $std_id ]                = '#2d2f38';
...
$fields['header_menu_st2_bbottom_color'][ $std_id ]  = '#e13434';
$fields['header_menu_text_color'][ $std_id ]         = '#ffffff';
$fields['header_menu_text_h_color'][ $std_id ]       = '#ffffff';
$fields['header_menu_bg_color'][ $std_id ]           = '#2d2f38';
$fields['footer_link_color'][ $std_id ]              = 'rgba(255,255,255,0.7)';
$fields['footer_link_hover_color'][ $std_id ]        = '#ffffff';
$fields['footer_widgets_bg_color'][ $std_id ]        = '#2d2f38';
$fields['footer_copy_bg_color'][ $std_id ]           = '#1f2027';
$fields['footer_bg_color'][ $std_id ]                = '#2d2f38';
$fields['section_title_color'][ $std_id ]            = '#ffffff';
$fields['section_title_bg_color'][ $std_id ]         = '#e13434';
