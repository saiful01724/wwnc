<?php
//
// Custom default values for designer-blog Demo
// 
...
$fields['home_listing'][ $std_id ]                   = 'grid-1';
$fields['home_top_posts'][ $std_id ]                 = 'style-22';
$fields['cat_slider'][ $std_id ]                     = 'disable';
$fields['cat_top_posts'][ $std_id ]                  = 'style-9';
...
$fields['header_top_padding'][ $std_id ]             = '29';
$fields['header_bottom_padding'][ $std_id ]          = '46';
...
$fields['theme_color'][ $std_id ]                    = '#d694b3';
$fields['topbar_text_color'][ $std_id ]              = '#1d1d1d';
$fields['topbar_border_color'][ $std_id ]            = '';
$fields['topbar_icon_text_color'][ $std_id ]         = '#1d1d1d';
$fields['header_top_border'][ $std_id ]              = '0';
$fields['header_menu_text_color'][ $std_id ]         = '#000000';
$fields['header_menu_bg_color'][ $std_id ]           = '#dbf8f5';
$fields['footer_link_color'][ $std_id ]              = '#000000';
$fields['footer_widgets_text'][ $std_id ]            = 'dark-text';
$fields['footer_copy_bg_color'][ $std_id ]           = 'rgba(255,255,255,0)';
$fields['footer_social_bg_color'][ $std_id ]         = 'rgba(255,255,255,0)';
$fields['footer_bg_color'][ $std_id ]                = 'rgba(255,255,255,0)';
$fields['section_title_color'][ $std_id ]            = '#272727';
$fields['section_title_bg_color'][ $std_id ]         = '#dbf8f5';
