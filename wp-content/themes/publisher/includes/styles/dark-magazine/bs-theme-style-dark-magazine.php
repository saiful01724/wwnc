 ...
 *      -> Dark Magazine Demo
 */
class Publisher_Theme_Style_Dark_Magazine extends Publisher_Theme_Style {
	...
	function panel_std( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/dark-magazine/panel-std.php';
	...
	function panel_css( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/dark-magazine/panel-css.php';
	...
	function register_assets() {
		...
		bf_enqueue_style(
			'publisher-theme-dark-magazine',
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_uri( 'dark-magazine/style' ), '.css' ),
			array( 'publisher' ),
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_path( 'dark-magazine/style' ), '.css' ),
...
} // Publisher_Theme_Style_Dark_Magazine
