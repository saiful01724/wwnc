 ...
 * Publisher -> Car News
 */
class Publisher_Theme_Style_Car_News extends Publisher_Theme_Style {
	...
	function panel_std( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/car-news/panel-std.php';
	...
	function panel_css( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/car-news/panel-css.php';
	...
	function register_assets() {
		...
		bf_enqueue_style(
			'publisher-theme-car-news',
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_uri( 'car-news/style' ), '.css' ),
			array( 'publisher' ),
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_path( 'car-news/style' ), '.css' ),
	...
	public function register_tinymce_assets() {
		...
		bf_enqueue_tinymce_style( 'registered', 'publisher-theme-car-news' );
	}
...
} // Publisher_Theme_Style_Car_News
