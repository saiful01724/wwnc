...
/**
 * Publisher -> Colorful Magazine
 */
class Publisher_Theme_Style_Colorful_Magazine extends Publisher_Theme_Style {
	...
	public function __construct() {
		...
		$this->style_id = 'colorful-magazine';
	...
	function panel_std( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/colorful-magazine/panel-std.php';
	...
	function panel_css( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/colorful-magazine/panel-css.php';
	...
	function customize_category_fields( $fields ) {
		...
		$term_css['color']['selector'][] = '.site-header.site-header .main-menu.menu > li.menu-term-%%id%%.current-menu-item > a';
		// Background Color
